...
fun BigInteger.square(): BigInteger = this.pow(2)
...
fun BigInteger.bigf(): BigFraction = BigFraction(this)
fun BigInteger.bigf(denominator: BigInteger): BigFraction = BigFraction(this, denominator)
