...
import math.combinatoric.createFactorials
import math.sequences.genSquareNumbers
import math.sequences.seqFibonacci
...
var SQUARES = genSquareNumbers().take(1000).toCollection(arrayListOf<Long>())
var SQUARES_SET = SQUARES.toHashSet()
var CUBES = 0L.seq().map { it * it * it }.take(1000).toCollection(arrayListOf<Long>())
var CUBES_SET = CUBES.toHashSet()
val FACTORIALS = createFactorials(21)
val FIBS = seqFibonacci().take(93).map { it.toLong() }.toCollection(arrayListOf<Long>())
